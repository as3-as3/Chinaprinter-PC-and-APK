...
📦 **Ready‑to‑use downloads** (APK + standalone Windows build) are on the
...
### 📱 Android
1. Download **`MXW01-Drucker.apk`** from the [latest release](../../releases/latest).
...
1. Download **`MXW01-Drucker-Portable.zip`** from the [latest release](../../releases/latest), extract it.
